...
（1）同步调用
 ...
 ![img](assets/1314805-20180516154723836-297657412.png)

同步调用是最基本并且最简单的一种调用方式，类A的方法a()调用类B的方法b()，一直等待b()方法执行完毕，a()方法继续往下走。**这种调用方式适用于方法b()执行时间不长的情况**，因为b()方法执行时间一长或者直接阻塞的话，a()方法的余下代码是无法执行下去的，这样会造成整个流程的阻塞。

（2）异步调用

![img](assets/1314805-20180516154841961-584583376.png)
...
![img](assets/1314805-20180516154958154-1937984501.png)
