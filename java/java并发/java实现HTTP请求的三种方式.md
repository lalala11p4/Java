...
此时我们可以编写测试类进行测试，如下是启动的springboot项目：

```java
    public static void main(String[] args) {
        System.out.println(doGet("http://localhost:8001/memeda/abc"));
    }
```
...
[更多可以参考:https://www.cnblogs.com/klslb/p/9121276.html](https://www.cnblogs.com/klslb/p/9121276.html)